...
const About = () => {
  ...
  return (
    <div className="flex flex-col w-full px-4 mt-36">
      <div className="flex flex-col items-center justify-center h-full px-4 mx-10" ref={comp}>
        <div className='flex flex-row items-start justify-center gap-10'>
          <img src={imageAbout} alt="image" className='w-[25%] rounded-2xl mt-3' id='imgabt'/>
          <div className="p-3 text-gray-300 w-[45%] text-lg" id='descabt'>
            <p>

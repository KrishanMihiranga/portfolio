        ...
        <footer className="fixed bottom-0 w-full p-4 mt-10 bg-black border-t border-gray-500 border-dashed">
            <div className="flex flex-col items-center justify-between mx-4 space-y-4 md:flex-row md:space-y-0">
                <div className="flex flex-row items-center justify-center space-x-2 md:flex-row md:space-y-0 md:space-x-4">
                    <Link to="/" className={classNames('text-sm md:text-lg text-regular hover:text-white', {
                        'text-white': currentPath === '/',
                    })}>HOME</Link>
                    <Link to="/about" className={classNames('text-sm md:text-lg text-regular hover:text-white', {
                        'text-white': currentPath === '/about',
                    })}>ABOUT</Link>
                    <Link to="/story" className={classNames('text-sm md:text-lg text-regular hover:text-white', {
                        'text-white': currentPath === '/story',
                    })}>STORY</Link>
                    <Link to="/work" className={classNames('text-sm md:text-lg text-regular hover:text-white', {
                        'text-white': currentPath === '/work',
                    })}>WORK</Link>
                    <Link to="/contact" className={classNames('text-sm md:text-lg text-regular hover:text-white', {
